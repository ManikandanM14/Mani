...
```bash
git clone https://github.com/ManikandanM14/sentiment-analysis-marketing.git
```
...
5. GitHub link: https://github.com/ManikandanM14/sentiment-analysis-marketing.git
...
12. 12.       1.download anaconda community software for desktop
...
3. Provide an overview of your project, its purpose, and its relevance to sentiment analysis in marketing.
